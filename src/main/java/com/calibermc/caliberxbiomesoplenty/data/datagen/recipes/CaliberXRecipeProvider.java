...
public class CaliberXRecipeProvider extends RecipeProvider implements IConditionBuilder {

    public CaliberXRecipeProvider(DataGenerator pGenerator) {
        super(pGenerator.getPackOutput());
    }

    @Override
    protected void buildRecipes(Consumer<FinishedRecipe> recipeConsumer) {
        List<String> blockManagerKeys = new ArrayList<>(Arrays.asList(CaliberXBiomesOPlenty.MOD_ID));
        if (ModCompats.BOP) {
